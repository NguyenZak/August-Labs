...
import { ArrowLeft, ExternalLink, ArrowRight, Image as ImageIcon, Utensils } from "lucide-react";
import Link from "next/link";
import { motion } from "framer-motion";
import { useLanguage } from "@/lib/i18n/LanguageContext";

export default function ProjectDetailContent({ project, related }: { project: any; related: any[] }) {
